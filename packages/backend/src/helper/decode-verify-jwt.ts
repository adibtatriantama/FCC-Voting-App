...
// https://github.com/awslabs/aws-support-tools/pull/201
...
const CLIENT_ID = process.env.COGNITO_POOL_CLIENT_ID || '';
if (!CLIENT_ID) {
  throw new Error('COGNITO_POOL_CLIENT_ID env var required');
}
