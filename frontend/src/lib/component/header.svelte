	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6">
		...
		>
			...
			<nav class="hidden md:flex space-x-10">
				...
				{#if $userStore}
					<a href="/mypoll" class="text-base font-medium text-gray-500 hover:text-gray-900">
						My Poll
					</a><a href="/createpoll" class="text-base font-medium text-gray-500 hover:text-gray-900">
						Create Poll
					</a>
				{/if}
			</nav>
